    ...
    <section class="relative group">
        ...
        <div
            ...
            <div
                ...
                <Link
                    v-if="hasAccess"
                    :href="route('admin.kontrak.edit', paket.enjiniring.rendan.lakdan.kontrak.id)"
                    ...
                    <div
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-sm font-bold text-gray-900 dark:text-white">
                                {{
                                    formatIDR(
                                        paket.enjiniring.rendan.lakdan.kontrak.nilai_perjanjian_ppn
                                    )
                                }}
                            </p>
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <div v-if="paket.enjiniring.rendan.lakdan.kontrak.dokumen_perjanjian">
                                <a
                                    @click="
                                        openPdfPreview(
                                            paket.enjiniring.rendan.lakdan.kontrak
                ...
                <div class="max-w-4xl space-y-6">
                    ...
                    <div
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-sm font-semibold text-gray-800 dark:text-gray-300">
                                {{
                                    paket.enjiniring.rendan.lakdan.kontrak.bank_pemberi_jaminan ||
                                    '-'
                                }}
                            </p>
                        </div>
                    ...
                    <div
                        ...
                        <div class="space-y-1">
                            ...
                            <p
                                ...
                                {{
                                    paket.enjiniring.rendan.lakdan.kontrak.penyedia_barang_jasa ||
                                    '-'
                                }}
                            </p>
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-sm font-semibold text-gray-800 dark:text-gray-300">
                                {{
                                    paket.enjiniring.rendan.lakdan.kontrak.tingkat_risiko_csms ||
                                    '-'
                                }}
                            </p>
                        </div>
