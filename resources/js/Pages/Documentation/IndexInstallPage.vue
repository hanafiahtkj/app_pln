            ...
            <div class="text-center">
                ...
                <div class="max-w-2xl mx-auto mb-8">
                    <p class="text-gray-700 dark:text-gray-200 text-lg">
                        Set up PLN in minutes with this step-by-step guide. Build your Laravel admin
                        interface with authentication, permissions, and modern UI components ready
                        to go.
                    </p>
                </div>
        ...
        <section class="space-y-10">
            ...
            <section id="prerequisites" class="scroll-mt-16 mb-12">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-700 dark:text-gray-200 max-w-2xl mx-auto">
                        Ensure you have the following requirements before installing PLN
                    </p>
                </div>
            ...
            <section id="installation" class="scroll-mt-16 mb-12">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-700 dark:text-gray-200 max-w-2xl mx-auto">
                        Follow these steps to get PLN up and running on your system
                    </p>
                </div>
                <div class="space-y-6">
                    <div
