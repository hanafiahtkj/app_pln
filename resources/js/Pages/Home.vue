...
<template>
    <Head title="PLN - Open Source Admin" />
    <div
        ...
        <section
            ...
            <div class="relative">
                ...
                <p
                    ...
                    Build amazing Laravel applications with ease. PLN provides ready-to-use features
                    like authentication, permissions, backup management, and auditing - all with
                ...
                <div class="max-w-3xl mx-auto">
                    ...
                    <div
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start">
                                <p class="text-gray-600 dark:text-gray-400 text-sm">
                                    That's why I made PLN: open-source, no bloat, no subscriptions.
                                    Just the essentials developers actually need.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative z-10 text-center">
                        ...
                        <p class="text-xl text-teal-100 dark:text-teal-200 mb-8 max-w-2xl mx-auto">
                            Start your next Laravel project with PLN; secure, modern, and ready to
                            use.
                        </p>
        ...
        <section
            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="text-center mb-16">
                    ...
                    <p class="text-gray-700 dark:text-gray-200 max-w-2xl mx-auto">
                        Everything you need to know about PLN
                    </p>
                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            ...
                            <div class="flex items-start mb-2">
                                <span class="text-green-600 dark:text-green-500 mr-2">⌾</span>
                                <h4 class="text-green-800 dark:text-green-200 font-bold">
                                    Does PLN include bloatware?
                                </h4>
                            </div>
                            <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                                <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    No. PLN only includes essential packages. You can remove any
                        ...
                        <div
                            ...
                            <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                                <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    Yes. PLN is modular - you can remove features like backups or
                                    permissions without breaking the app.
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-start mb-2">
                                <span class="text-green-600 dark:text-green-500 mr-2">⌾</span>
                                <h4 class="text-green-800 dark:text-green-200 font-bold">
                                    Does PLN replace Jetstream or Fortify?
                                </h4>
                            </div>
                            <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                                <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    No. PLN builds on Fortify and ships a ready Vue + Inertia
                        ...
                        <div
                            ...
                            <div class="flex items-start mb-2">
                                <span class="text-green-600 dark:text-green-500 mr-2">⌾</span>
                                <h4 class="text-green-800 dark:text-green-200 font-bold">
                                    Does PLN include CRUD generators?
                                </h4>
                            </div>
                            <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                                <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    No. PLN handles app essentials; you can add CRUD generators
                                    separately.
                                </p>
                            </div>
                        </div>
