...
const form = useForm({
    ...
    dokumen_penunjukan_pemenang: null,

    // 1. Persiapan Pengadaan
    rencana_persiapan_pengadaan: '',
    realisasi_persiapan_pengadaan: '',
    persiapan_pengadaan: '',
    ...
    rencana_pendaftaran_ambil_dokumen: '',
    realisasi_pendaftaran_ambil_dokumen: '',
    pendaftaran_ambil_dokumen: '',

    // 4. Aanwijzing
    rencana_aanwijzing: '',
    realisasi_aanwijzing: '',
    aanwijzing: '',

    // 5. Pemasukan Dokumen Penawaran
    rencana_pemasukan_penawaran: '',
    realisasi_pemasukan_penawaran: '',
    pemasukan_penawaran: '',

    // 6. Pembukaan Dokumen dan Evaluasi
    rencana_pembukaan_evaluasi: '',
    realisasi_pembukaan_evaluasi: '',
    pembukaan_evaluasi: '',

    // 7. Klarifikasi dan Negosiasi Harga
    rencana_klarifikasi_negosiasi: '',
    realisasi_klarifikasi_negosiasi: '',
    klarifikasi_negosiasi: '',

    // 8. Usulan Penetapan Pemenang
    rencana_usulan_penetapan_pemenang: '',
    realisasi_usulan_penetapan_pemenang: '',
    usulan_penetapan_pemenang: '',

    // 9. Izin Prinsip Tanda Tangan Kontrak
    rencana_izin_prinsip_kontrak: '',
    realisasi_izin_prinsip_kontrak: '',
    izin_prinsip_kontrak: '',

    // 10. Penetapan dan Pengumuman Pemenang
    rencana_penetapan_pengumuman_pemenang: '',
    realisasi_penetapan_pengumuman_pemenang: '',
...
onMounted(() => {
    ...
    const rendanIdFromUrl = urlParams.get('rendan_id')

    if (rendanIdFromUrl) {
        form.rendan_id = rendanIdFromUrl
        isLocked.value = true
    }
})
</script>
...
<template>
    ...
    <main class="mx-auto space-y-8" aria-labelledby="create-lakdan">
