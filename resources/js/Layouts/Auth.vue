...
<template>
    <div
        ...
        style="
            background-image: url('images/Gemini_Generated_Image_r9jny7r9jny7r9jn.webp');
            background-size: cover;
            background-position: center;
        ">
        <main class="flex flex-col justify-center flex-grow py-8">
        ...
        <footer class="border-t border-gray-200 dark:border-gray-700 dark:bg-gray-800">
            <section
                ...
                <p class="text-center text-xs text-gray-500 dark:text-gray-300 md:order-1">
                    ...
                    {{ personalisation.copyright_text || '© 2025 All rights reserved.' }}
                </p>
            </section>
        </footer>
    </div>
