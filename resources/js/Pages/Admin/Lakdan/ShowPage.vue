        ...
        <div class="container-border overflow-hidden">
            <PageHeader
                ...
                :breadcrumbs="[
                    ...
                    { label: 'Data Paket', href: route('admin.lakdan.index') },
                    { label: 'Detail' }
                ]">
                <template #actions>
                    <Link :href="route('admin.lakdan.index')" class="btn-primary btn-sm">
                        Kembali ke Daftar
                    </Link>
                </template>
            </PageHeader>
            ...
            <div class="p-6 md:p-8 relative">
                ...
                <div class="space-y-12">
                    ...
                    <LakdanCard :hasAccess="true" :paket="paket" @openPdfPreview="openPdfPreview" />
